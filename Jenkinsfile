pipeline {
    ...
    environment {
        IMAGE_NAME = "ebrahimmohammed/jenkins-theme"       // اسم الصورة على Docker Hub
        MAVEN_IMAGE = "maven:3.9.0-eclipse-temurin-11"    // نسخة Maven + OpenJDK11 موجودة على Docker Hub
    }
    ...
    stages {
        ...
        stage('Run Unit Tests') {
            steps {
                // جمع تقارير الاختبارات من Maven
        ...
        stage('Push to Docker Hub') {
            when { branch 'main' }   // فقط للـ main branch
            steps {
